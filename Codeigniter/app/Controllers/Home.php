...
class Home extends BaseController
{
    ...
    public function showFormUpdate($id_param)
    {
        $automoveis_model = new AutomoveisModel;
    ...
    public function updateData()
    {
        ...
        $data = array(
            'marca' => $this->request->getVar('marca_update'),
            'modelo' => $this->request->getVar('modelo_update'),
            'km' => $this->request->getVar('km_update'),
            'ano' => $this->request->getVar('ano_update'),
            'preco' => $this->request->getVar('preco_update')
        );

        $automoveis_model = new AutomoveisModel;
        $automoveis_model->update($id_for_updating, $data);
        $this->session->setFlashdata('edit','Dados editados com sucesso');
        return redirect()->to('/listar');
    }
